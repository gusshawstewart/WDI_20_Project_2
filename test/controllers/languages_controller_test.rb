...
class LanguagesControllerTest < ActionController::TestCase
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post :create, language: { language: @language.language, user_id: @language.user_id }
    end
  ...
  test "should update language" do
    patch :update, id: @language, language: { language: @language.language, user_id: @language.user_id }
    assert_redirected_to language_path(assigns(:language))
  end
